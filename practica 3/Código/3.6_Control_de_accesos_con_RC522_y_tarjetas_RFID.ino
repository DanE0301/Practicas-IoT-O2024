//Práctica 3 - Daniela Elizondo Hernández
//En este ejercicio se muestra como dar acceso a ciertos UID y se muestre con algo físico como son los LED para dar acceso o denegarlo
...
byte Usuario1[4] = {0x5D, 0x52, 0x04, 0xB9}; // UID tarjeta CON acceso (reemplaza por tu UID ITESO)
byte Usuario2[4] = {0x19, 0x1B, 0xDD, 0xC2}; // UID de otra tarjeta que quieras que tenga acceso
